            ...
            <main className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {plans.map((plan, index) => (
                        <div
                            key={plan.id}
                            className={`relative glass-card p-10 rounded-[2.5rem] flex flex-col border transition-all hover:scale-[1.02] duration-300 animate-fade-in ${plan.highlight ? "border-emerald-500/50 shadow-emerald-500/10 shadow-2xl" : "border-white/10"
                                }`}
                        ...
                        >
                            ...
                            <button
                                ...
                                className={`w-full py-5 rounded-2xl font-bold transition-all flex items-center justify-center gap-2 ${plan.highlight
